...
import (
	...
	clusterv1beta1 "github.com/fulsiram/provider-upjet-warpgate/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/fulsiram/provider-upjet-warpgate/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal warpgate credentials as JSON"
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		if v, ok := creds[keyInsecureSkipVerify]; ok {
			ps.Configuration[keyInsecureSkipVerify] = v == "true"
		}
		return ps, nil
	}
}
