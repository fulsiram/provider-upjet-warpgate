...
func (mg *Target) GetTerraformResourceType() string {
	return "warpgate_target"
}

// GetConnectionDetailsMapping for this Target
func (tr *Target) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"kubernetes_options[*].certificate_auth[*].private_key": "kubernetesOptions[*].certificateAuth[*].privateKeySecretRef", "kubernetes_options[*].token_auth[*].token": "kubernetesOptions[*].tokenAuth[*].tokenSecretRef", "mysql_options[*].password": "mysqlOptions[*].passwordSecretRef", "postgres_options[*].password": "postgresOptions[*].passwordSecretRef", "ssh_options[*].password_auth[*].password": "sshOptions[*].passwordAuth[*].passwordSecretRef"}
}
