...
func (mg *Parameters) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this Parameters.
func (mg *Parameters) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *Parameters) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this Parameters.
func (mg *Parameters) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
